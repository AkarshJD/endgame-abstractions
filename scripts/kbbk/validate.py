"""
KBBK WDL validation — full dataset accuracy + misclassified positions.
...
FEATURES_PATH = "data/processed/kbbk/features.csv"
MODEL_BASE    = "logs/kbbk_classifier"
...
def main():
    ...
    run_dir = make_run_dir(base="logs/kbbk_validation")
