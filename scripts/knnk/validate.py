"""
KNNK WDL validation — full dataset accuracy + misclassified positions.
...
FEATURES_PATH = "data/processed/knnk/features.csv"
MODEL_BASE    = "logs/knnk_classifier"
...
def main():
    ...
    run_dir = make_run_dir(base="logs/knnk_validation")
